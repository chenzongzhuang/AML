...
public class Cust extends Model<Cust>{
	...
	public String toString() {
		return "Cust {id=" + id + ", clientTp=" + clientTp + ", accountTp=" + accountTp + ", busiType=" + busiType
				+ ", busiRegNo=" + busiRegNo + ", ctnm=" + ctnm + ", smid=" + smid + ", education=" + education
				+ ", marriage=" + marriage + ", ceml=" + ceml + ", ctvc=" + ctvc + ", rgdt=" + rgdt + ", clsDt=" + clsDt
				+ ", redt=" + redt + ", country=" + country + ", nation=" + nation + ", sex=" + sex + ", birthday="
				+ birthday + ", endtime=" + endtime + ", agencyCtnm=" + agencyCtnm + ", agencyCitp=" + agencyCitp
				+ ", agencyCtid=" + agencyCtid + ", agencyCdt=" + agencyCdt + ", remark=" + remark + ", tsdt1=" + tsdt1
				+ ", tsdt2=" + tsdt2 + ", extend1=" + extend1 + ", extend2=" + extend2 + ", extend3=" + extend3
				+ ", extend4=" + extend4 + ", extend5=" + extend5 + ", curInNum=" + curInNum + ", curInAmt=" + curInAmt
				+ ", curOutNum=" + curOutNum + ", curOutAmt=" + curOutAmt + ", accInNum=" + accInNum + ", accInAmt="
				+ accInAmt + ", accOutNum=" + accOutNum + ", accOutAmt=" + accOutAmt + ", riskLevel=" + riskLevel
				+ ", compScore=" + compScore + ", succNum=" + succNum + ", reptNum=" + reptNum + ", stdt=" + stdt
				+ ", induCode=" + induCode + ", statFlag=" + statFlag + ", merProv=" + merProv + ", merArea=" + merArea
				+ ", merUnit=" + merUnit + ", nextDate=" + nextDate + ", isLine=" + isLine + ", createTime="
				+ createTime + ", updateTime=" + updateTime + ", runDt=" + runDt + ", hashcode=" + hashcode + "}";
	}
