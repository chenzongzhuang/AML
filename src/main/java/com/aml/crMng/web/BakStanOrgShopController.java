...
@Controller
@RequestMapping("/crMng/orgMerchant")
public class BakStanOrgShopController extends BaseController {
	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	private final static String PRE_FIX = "crMng/orgMerchant/";
	// @Autowired
	...
	public AjaxResult getExcel() {
		...
		map = iExportExcelService.exportBakStanOrgShopFile(listCust);
	...
	public void getExcelForm() {
		...
		String filePath = amlPath+"download\\orgMerchant.xls";
		 response.setContentType("application/octet-stream;charset=UTF-8");  
         //下载  
          response.setHeader("Content-disposition", "attachment;filename=orgMerchant.xls"); //文件名，在这下载了是乱码
