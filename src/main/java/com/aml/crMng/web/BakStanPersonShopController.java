...
@Controller
@RequestMapping("/crMng/perMerchant")
public class BakStanPersonShopController extends BaseController {
	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	private final static String PRE_FIX = "crMng/perMerchant/";
	// @Autowired
	...
	public AjaxResult getExcel() {
		...
		map = iExportExcelService.exportBakStanPersonShopFile(listCust);
	...
	public void getExcelForm() {
		...
		String filePath = amlPath+"download\\perMerchant.xls";
		 response.setContentType("application/octet-stream;charset=UTF-8");  
         //下载  
          response.setHeader("Content-disposition", "attachment;filename=perMerchant.xls"); //文件名，在这下载了是乱码
