...
@Controller
@RequestMapping("/crMng/orgCustomer")
public class BakStanOrgCustController extends BaseController {
	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	private final static String PRE_FIX = "crMng/orgCustomer/";
	// @Autowired
	// private ICustService custService;
	@Autowired
	private IBakStanOrgService bakStanOrgService;
	...
	public AjaxResult toPerCustomer() {
		...
		Map<String, Object> map = new HashMap<>();
		List<BakStanOrg> listCust = bakStanOrgService.findAllBakStanOrg(page, busiRegNo, ctnm, clientTp, agencyCtid,
				endtime, riskLevel, merUnit, rgdtStart, rgdtEnd);
	...
	public AjaxResult getExcel() {
		...
		Map<String, Object> resObj = new HashMap<String, Object>();
		List<BakStanOrg> listCust = bakStanOrgService.findAllBakStanOrg(busiRegNo, ctnm, clientTp, agencyCtid,
				endtime, riskLevel, merUnit, rgdtStart, rgdtEnd);

		map = iExportExcelService.exportBakStanOrgCustFile(listCust);
	...
	public void getExcelForm() {
		...
		String filePath = amlPath+"download\\orgCustomer.xls";
		 response.setContentType("application/octet-stream;charset=UTF-8");  
         //下载  
          response.setHeader("Content-disposition", "attachment;filename=orgCustomer.xls"); //文件名，在这下载了是乱码
