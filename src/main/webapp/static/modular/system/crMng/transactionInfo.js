...
var dataUrl = ctxPath + "/crMngInfo/toTransactionInfo";
//初始化Table
var TableInit = function() {
	var oTableInit = new Object();
	//初始化Table
	oTableInit.Init = function() {
		$('#transactionInfoTable').bootstrapTable({
...
//    });
	return {
	    ...
	    tstmStart:$('#tstmStart').val(),
	    tstmEnd:$('#tstmEnd').val(),
	    tsdr:$('#tsdr').val(),
	    cratLeft:$('#cratLeft').val(),
	    cratRight:$('#cratRight').val(),
	    ticd:$('#ticd').val()
	};
}
