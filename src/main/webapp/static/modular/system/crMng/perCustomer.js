...
var dataUrl = ctxPath + "/crMng/perCustomer/toPerCustomer";
//初始化Table
...
, {
  ...
  , {
	...
	formatter:function(value,row,index){
		//var e = '<a href="/crMngInfo/first?busiRegNo=\''+ row.busiRegNo + '\'">尽职调查</a> ';
		 var e = '<a href="#" onclick="look(\''+ row.busiRegNo + '\',\''+ row.ctnm + '\')">尽职调查</a> ';
		 return e;     
		} 
	}
];

function look(busiRegNo,ctnm){
	top.location = "/crMngInfo/first?busiRegNo="+ busiRegNo+"&ctnm="+ctnm;
}
...
$("#exportExcel").click(function(){
	...
	oTable.Init();
	$.ajax({
		url:'/crMng/perCustomer/exportExcel',
		dataType:'json',
		data:$("#excelForm").serialize(),
		success:function(data){
			if(data.data.result=="success"){
				document.getElementById("excelForm").action="/crMng/perCustomer/downExcel";
