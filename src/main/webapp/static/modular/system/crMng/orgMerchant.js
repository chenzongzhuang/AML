...
var dataUrl = ctxPath + "/crMng/orgMerchant/toPerCustomer";
//初始化Table
...
$("#exportExcel").click(function(){
	...
	oTable.Init();
	$.ajax({
		url:'/crMng/orgMerchant/exportExcel',
		dataType:'json',
		data:$("#excelForm").serialize(),
		success:function(data){
			if(data.data.result=="success"){
				document.getElementById("excelForm").action="/crMng/orgMerchant/downExcel";
