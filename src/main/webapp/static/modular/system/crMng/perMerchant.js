...
var dataUrl = ctxPath + "/crMng/perMerchant/toPerCustomer";
//初始化Table
...
$("#exportExcel").click(function(){
	...
	oTable.Init();
	$.ajax({
		url:'/crMng/perMerchant/exportExcel',
		dataType:'json',
		data:$("#excelForm").serialize(),
		success:function(data){
			if(data.data.result=="success"){
				document.getElementById("excelForm").action="/crMng/perMerchant/downExcel";
