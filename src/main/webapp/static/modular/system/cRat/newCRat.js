$(function() {
	//1.初始化Table
	var oTable = new newCRatTableInit();
	oTable.Init();
	 //2.初始化Button的点击事件
...
//初始化Table
var newCRatTableInit = function() {
	var newCRatTableInit = new Object();
	//初始化Table
	newCRatTableInit.Init = function() {
		$('#newCRatDataTable').bootstrapTable({
...
$("#exportExcel").click(function(){
	...
	$('#newCRatDataTable').bootstrapTable('destroy');  
	var oTable = new newCRatTableInit();
	oTable.Init();
	$.ajax({
		url:'/produceExcel',
		...
		success:function(data){
			if(data.data.result=="success"){
				document.getElementById("excelForm").action="/downExcel";
...
$("#newCRatQry").click(function(){
	//1.初始化Table
	$('#newCRatDataTable').bootstrapTable('destroy');  
	var oTable = new newCRatTableInit();
	oTable.Init();
});
$("#newCRatRefQry").click(function(){
	//1.初始化Table
	$('#newCRatDataTable').bootstrapTable('destroy');  
	var oTable = new newCRatTableInit();
	oTable.Init();
